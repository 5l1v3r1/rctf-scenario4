...
void ConveyorBeltPlugin::OnUpdate()
{
  ...
  // Reset the belt.
  if (this->joint->Position(0) >= this->limit.Radian())
  {
    // Warning: Megahack!!
    ...
    ignition::math::Pose3d childLinkPose(1.20997, 2.5998, 0.8126, 0, 0, -1.57);
    ignition::math::Pose3d newChildLinkPose(1.20997, 2.98, 0.8126, 0, 0, -1.57);
